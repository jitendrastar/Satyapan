...
export class ForwardToPage {
  ...
  constructor(public viewCtrl: ModalController,public route: ActivatedRoute, public navCtrl: NavController,public navparams: NavParams,public alertCtrl: AlertController,  public storage: Storage, public httpClient: CommonService) {
