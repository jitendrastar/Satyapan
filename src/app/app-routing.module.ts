...
const routes: Routes = [
  ...
  },
  {
    path: "ksk-update",
    loadChildren: () =>
      import("./ksk-update/ksk-update.module").then(
        (m) => m.KskUpdatePageModule
      ),
  },
  {
    path: "assignmodal",
    loadChildren: () =>
      import("./licenseFolder/assignmodal/assignmodal.module").then(
        (m) => m.AssignmodalPageModule
      ),
  },
  {
    ...
    loadChildren: () =>
      import(
        "./licenseFolder/applicant-list-completed/applicant-list-completed.module"
      ).then((m) => m.ApplicantListCompletedPageModule),
  },
  {
    path: "application-verification-completed",
    loadChildren: () =>
      import(
        "./licenseFolder/application-verification-completed/application-verification-completed.module"
      ).then((m) => m.ApplicationVerificationCompletedPageModule),
  },
  {
    path: "assigned-list",
    loadChildren: () =>
      import("./licenseFolder/assigned-list/assigned-list.module").then(
        (m) => m.AssignedListPageModule
      ),
  },
  {
    path: "demonstration-dashboard",
    loadChildren: () =>
      import(
        "./demonstation/demonstration-dashboard/demonstration-dashboard.module"
      ).then((m) => m.DemonstrationDashboardPageModule),
  },
  {
    path: "jan-aadhar-detail-model",
    loadChildren: () =>
      import(
        "./demonstation/model/jan-aadhar-detail-model/jan-aadhar-detail-model.module"
      ).then((m) => m.JanAadharDetailModelPageModule),
  },
  {
    path: "as-list",
    loadChildren: () =>
      import("./demonstation/as-list/as-list.module").then(
        (m) => m.AsListPageModule
      ),
  },
  {
    path: "demonstration-aslevel",
    loadChildren: () =>
      import(
        "./demonstation/demonstration-aslevel/demonstration-aslevel.module"
      ).then((m) => m.DemonstrationAslevelPageModule),
  },
  {
    path: "demonstration-beneficiary",
    loadChildren: () =>
      import(
        "./demonstation/demonstration-beneficiary/demonstration-beneficiary.module"
      ).then((m) => m.DemonstrationBeneficiaryPageModule),
  },
  {
    path: "demonstration-sowing",
    loadChildren: () =>
      import(
        "./demonstation/demonstration-sowing-member-list/demonstration-sowing-member-list.module"
      ).then((m) => m.DemonstrationSowingMemberListPageModule),
  },
  {
    path: "demonstration-harvesting",
    loadChildren: () =>
      import(
        "./demonstation/demonstration-harvesting-member-list/demonstration-harvesting-member-list.module"
      ).then((m) => m.DemonstrationHarvestingMemberListPageModule),
  },
  {
    path: "product-allotment-model",
    loadChildren: () =>
      import(
        "./demonstation/model/product-allotment-model/product-allotment-model.module"
      ).then((m) => m.ProductAllotmentModelPageModule),
  },
  {
    path: "ksk-upload-image",
    loadChildren: () =>
      import("./ksk-upload-image/ksk-upload-image.module").then(
        (m) => m.KskUploadImagePageModule
      ),
  },
  {
    path: "add-godown",
    loadChildren: () =>
      import("./licenseFolder/model/add-godown/add-godown.module").then(
        (m) => m.AddGodownPageModule
      ),
  },
  {
    path: "poly-house-post-verification",
    loadChildren: () =>
      import(
        "./poly-house-post-verification/poly-house-post-verification.module"
      ).then((m) => m.PolyHousePostVerificationPageModule),
  },
  {
    path: "shade-net-house-post-verification",
    loadChildren: () =>
      import(
        "./shade-net-house-post-verification/shade-net-house-post-verification.module"
      ).then((m) => m.ShadeNetHousePostVerificationPageModule),
  },
  {
    path: "plastic-mulch-post-verification",
    loadChildren: () =>
      import(
        "./plastic-mulch-post-verification/plastic-mulch-post-verification.module"
      ).then((m) => m.PlasticMulchPostVerificationPageModule),
  },
  {
    path: "low-tunnel-post-verification",
    loadChildren: () =>
      import(
        "./low-tunnel-post-verification/low-tunnel-post-verification.module"
      ).then((m) => m.LowTunnelPostVerificationPageModule),
  },
  {
    path: "crop-disease-submitted-list",
    loadChildren: () =>
      import(
        "./cropDiseaseTreatment/crop-disease-submitted-list/crop-disease-submitted-list.module"
      ).then((m) => m.CropDiseaseSubmittedListPageModule),
  },
  {
    path: "crop-disease-request",
    loadChildren: () =>
      import(
        "./cropDiseaseTreatment/crop-disease-request/crop-disease-request.module"
      ).then((m) => m.CropDiseaseRequestPageModule),
  },
  {
    path: "crop-disease-request-detail",
    loadChildren: () =>
      import(
        "./cropDiseaseTreatment/crop-disease-request-detail/crop-disease-request-detail.module"
      ).then((m) => m.CropDiseaseRequestDetailPageModule),
  },
  {
    path: "wheather-update",
    loadChildren: () =>
      import("./licenseFolder/wheather-update/wheather-update.module").then(
        (m) => m.WheatherUpdatePageModule
      ),
  },
  {
    path: "wheather-update-image",
    loadChildren: () =>
      import("./wheather-update-image/wheather-update-image.module").then(
        (m) => m.WheatherUpdateImagePageModule
      ),
  },
  {
    path: "onion-storage-post-verification",
    loadChildren: () =>
      import(
        "./ManufacturerDealerFolder/onion-storage-post-verification/onion-storage-post-verification.module"
      ).then((m) => m.OnionStoragePostVerificationPageModule),
  },
  {
    path: "barbed-wire-fencing",
    loadChildren: () =>
      import("./barbed-wire-fencing/barbed-wire-fencing.module").then(
        (m) => m.BarbedWireFencingPageModule
      ),
  },
  {
    path: "barbed-wire-fencing-pre-verification",
    loadChildren: () =>
      import(
        "./barbed-wire-fencing-pre-verification/barbed-wire-fencing-pre-verification.module"
      ).then((m) => m.BarbedWireFencingPreVerificationPageModule),
  },
  {
    path: 'solar-post-verification',
    loadChildren: () => import('./ManufacturerDealerFolder/solar-post-verification/solar-post-verification.module').then(m => m.SolarPostVerificationPageModule)
  },
  {
    path: 'assign-submission-aao',
    loadChildren: () => import('./assign-submission-aao/assign-submission-aao.module').then(m => m.AssignSubmissionAaoPageModule)
  },
  {
    path: "orchard-post-verification",
    loadChildren: () =>
      import(
        "./ManufacturerDealerFolder/orchard-post-verification/orchard-post-verification.module"
      ).then((m) => m.OrchardPostVerificationPageModule),
  },
  {
    path: "mini-kit-dashboard",
    loadChildren: () =>
      import(
        "./mini-kit/mini-kit-dashboard/mini-kit-dashboard.module"
      ).then((m) => m.MiniKitDashboardPageModule),
  },
  {
    path: "mini-kit-aslevel",
    loadChildren: () =>
      import(
        "./mini-kit/mini-kit-aslevel/mini-kit-aslevel.module"
      ).then((m) => m.MiniKitAslevelPageModule),
  },
  {
    path: "mini-kit-jan-aadhar-detail-model",
    loadChildren: () =>
      import(
        "./mini-kit/mini-kit-model/jan-aadhar-detail-model/jan-aadhar-detail-model.module"
      ).then((m) => m.JanAadharDetailModelPageModule),
  },
  {
    path: "mini-kit-product-allotment-model",
    loadChildren: () =>
      import(
        "./mini-kit/mini-kit-model/product-allotment-model/product-allotment-model.module"
      ).then((m) => m.ProductAllotmentModelPageModule),
  },
  {
    path: "mbsy-dashboard",
    loadChildren: () =>
      import(
        "./mbsy/mbsy-dashboard/mbsy-dashboard.module"
      ).then((m) => m.MBSYDashboardPageModule),
  },
  {
    path: 'mbsy-group',
    loadChildren: () => import('./mbsy/mbsy-group/mbsy-group.module').then(m => m.MbsyGroupPageModule)
  },
  {
    path: 'mbsy-add-farmer',
    loadChildren: () => import('./mbsy/mbsy-modal/add-farmer-model/add-farmer-model.module').then(m => m.AddFarmerModelPageModule)
  },
  {
    path: 'mbsy-farmer-list',
    loadChildren: () => import('./mbsy/mbsy-farmer-list/mbsy-farmer-list.module').then(m => m.MbsyFarmerListPageModule)
  },
  {
    path: 'mbsy-cal-distribution',
    loadChildren: () => import('./mbsy/mbsy-cal-allotment/mbsy-cal-allotment.module').then(m => m.MbsyCalAllotmentPageModule)
  },
  {
    path: 'mbsy-final-distribution',
    loadChildren: () => import('./mbsy/mbsy-final-allotment/mbsy-final-allotment.module').then(m => m.MbsyFinalAllotmentPageModule)
  },
  {
    path: "mbsy-product-allotment-model",
    loadChildren: () =>
      import(
        "./mbsy/mbsy-modal/product-allotment-model/product-allotment-model.module"
      ).then((m) => m.ProductAllotmentModelPageModule),
  },
  {
    path: 'tranning-init',
    loadChildren: () => import('./mbsy/trainning/tranning-init/tranning-init.module').then(m => m.TranningInitPageModule)
  },
  {
    path: "mbsy-upload-images",
    loadChildren: () =>
      import("./mbsy/mbsy-modal/upload-images/upload-images.module").then(
        (m) => m.UploadImagesPageModule
      ),
  },
  {
    path: 'whs',
    loadChildren: () => import('./whs/whs.module').then( m => m.WhsPageModule)
  },
  {
    path: 'whs-pre-verification',
    loadChildren: () => import('./whs-pre-verification/whs-pre-verification.module').then( m => m.WhsPreVerificationPageModule)
  },
  {
    path: 'event-list',
  ...
  {
    path: 'pp-chemical-list',
    loadChildren: () => import('./pp-chemical-list/pp-chemical-list.module').then( m => m.PpChemicalListPageModule)
  },
  {
    path: 'add-pp-chemical',
    loadChildren: () => import('./add-pp-chemical/add-pp-chemical.module').then( m => m.AddPpChemicalPageModule)
  },
];
