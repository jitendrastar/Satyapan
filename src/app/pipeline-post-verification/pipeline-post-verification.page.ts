...
export class PipelinePostVerificationPage implements OnInit {
    ...
    nakshaTrace: any;
    btnsubmitYesFormWithGranted:boolean = false;
    btnSubmitYesSubsidyGrantedNoForm:boolean = false;
...
ionViewWillEnter(){
    ...
    submitYesSubsidyGrantedNoForm() {
        this.btnSubmitYesSubsidyGrantedNoForm = true;
        ...
        if (this.longitude == null ||this.longitude == null ||this.longitude  == null) {
            ...
            this.btnSubmitYesSubsidyGrantedNoForm = false;
        }
    ...
    submitYesFormWithGranted() {
        this.btnsubmitYesFormWithGranted = true;
        var tempOfflineFlag;
        if (this.httpClient.isOffline == true) {
            tempOfflineFlag = 1;
        } else {
        ...
        if (this.isSixMonthOld == 'yes' && this.jamabandiArray.length == 0) {
            ...
            this.btnsubmitYesFormWithGranted = false;
        }
