...
export class DatabaseServiceService {
            ...
            if (!this.platform.is("mobileweb")) {
                this.sqlite
                    ...
                    .then((db: SQLiteObject) => {
                        ...
                        this.storage.executeSql("create table if not exists postVerificationOfflineOfPolyHouse(ApplicationId CHAR(10) PRIMARY KEY,applicationData CHAR(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999))",
                            []
                        )
                            .then(() => console.log("Executed SQL"))
                            .catch((error) => {
                        ...
                        this.storage.executeSql("create table if not exists postVerificationOfflineOfShadeNetHouse(ApplicationId CHAR(10) PRIMARY KEY,applicationData CHAR(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999))",
                            []
                        )
                            .then(() => console.log("Executed SQL"))
                            .catch((error) => {
                        ...
                        this.storage.executeSql("create table if not exists postVerificationOfflineOfPlasticMulch(ApplicationId CHAR(10) PRIMARY KEY,applicationData CHAR(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999))",
                            []
                        )
                            .then(() => console.log("Executed SQL"))
                            .catch((error) => {
                        ...
                        this.storage.executeSql("create table if not exists postVerificationOfflineOfLowTunnel(ApplicationId CHAR(10) PRIMARY KEY,applicationData CHAR(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999))",
                            []
                        )
                            .then(() => console.log("Executed SQL"))
                            .catch((error) => {
    ...
    addSubsidyScheme(
        ...
        if (!this.platform.is("mobileweb")) {
            ...
            return this.storage.executeSql("INSERT INTO dashboard (SubsidySchemeId, SubsidySchemeHi, SubsidySchemeEn, DashboardImg) VALUES (?, ?, ?, ?)", dataToInsert).then((val) => {
    ...
    // postVerificationOfflineOfPolyHouse
    addpostVerificationOfflineOfPolyHouse(ApplicationId, applicationData) {
        if (!this.platform.is("mobileweb")) {
            console.log("ssjhcksjck");
            ...
            return this.storage
                .executeSql(
                    "INSERT INTO postVerificationOfflineOfPolyHouse ( ApplicationId, applicationData) VALUES (?, ?)", dataToInsert)
                .then((val) => {
                    this.httpClient.showToast('This application is saved for Offline');
                })
                .catch((error) => {
    ...
    // postVerificationOfflineOfShadeNetHouse
    addpostVerificationOfflineOfShadeNetHouse(ApplicationId, applicationData) {
        if (!this.platform.is("mobileweb")) {
            console.log("ssjhcksjck");
            ...
            return this.storage
                .executeSql(
                    "INSERT INTO postVerificationOfflineOfShadeNetHouse ( ApplicationId, applicationData) VALUES (?, ?)", dataToInsert)
                .then((val) => {
                    this.httpClient.showToast('This application is saved for Offline');
                })
                .catch((error) => {
    ...
    // postVerificationOfflineOfPlasticMulch
    addpostVerificationOfflineOfPlasticMulch(ApplicationId, applicationData) {
        if (!this.platform.is("mobileweb")) {
            console.log("ssjhcksjck");
            ...
            return this.storage
                .executeSql(
                    "INSERT INTO postVerificationOfflineOfPlasticMulch ( ApplicationId, applicationData) VALUES (?, ?)", dataToInsert)
                .then((val) => {
                    this.httpClient.showToast('This application is saved for Offline');
                })
                .catch((error) => {
    ...
    // postVerificationOfflineOfLowTunnel
    addpostVerificationOfflineOfLowTunnel(ApplicationId, applicationData) {
        if (!this.platform.is("mobileweb")) {
            console.log("ssjhcksjck");
            ...
            return this.storage
                .executeSql(
                    "INSERT INTO postVerificationOfflineOfLowTunnel ( ApplicationId, applicationData) VALUES (?, ?)", dataToInsert)
                .then((val) => {
                    this.httpClient.showToast('This application is saved for Offline');
                })
                .catch((error) => {
