...
@Component({
  selector: 'app-wheather-update-image',
  templateUrl: './wheather-update-image.page.html',
  styleUrls: ['./wheather-update-image.page.scss'],
})
export class WheatherUpdateImagePage implements OnInit {
