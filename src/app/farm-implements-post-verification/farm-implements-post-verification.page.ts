...
export class FarmImplementsPostVerificationPage {
    ...
    jamabandiArray: any = [];
    btnSubmitYesForm:boolean = false;
    ...
    async addBill() {
        ...
        const modal = await this.modalController.create({
            ...
            componentProps: {
                ...
                purchaseBeforeAS: this.getPreVerificationData.ImpPurchaseBeforeAS
            },
            //
        });
    ...
    submitYesForm() {
        ...
        if (this.latitude == null ||this.latitude == null ||this.latitude  == null) {
            ...
            this.btnSubmitYesForm = false;
        } else if (this.longitude == null ||this.longitude == null ||this.longitude  == null) {
            this.getLoc();
            ...
            this.btnSubmitYesForm = false;
        } else if(this.selectredDealer == 0 && !this.dealerName) {
            if (this.httpClient.currentLanguage == "english") {
                this.httpClient.showToast("Please enter Dealer Name");
            } else {
                this.httpClient.showToast("कृपया डीलर का नाम दर्ज करें");
            }
            this.btnSubmitYesForm = false;
        }else if(!this.impPurchased){
            if (this.httpClient.currentLanguage == "english") {
                this.httpClient.showToast("Select implement purchased before As date.");
            } else {
                this.httpClient.showToast("तिथि से पहले खरीदे गए कार्यान्वयन का चयन करें।");
            }
            this.btnSubmitYesForm = false;
        }else{
            var self = this;
            ...
            var sendRequestData = {
                obj: {
                    ...
                    srvparam: JSON.stringify({
                        ...
                        ImpPurchaseBeforeAS : this.impPurchased
                    }),
                },
            };
            console.log("sendRequestData", sendRequestData);
