...
export class OfflineModePage implements OnInit {
  dashboardList: any = [];
  constructor(public geolocation: Geolocation,public actionSheetController: ActionSheetController, public dbService: DatabaseServiceService, public router: Router, public httpClient: CommonService) {
