...
export class PostSubsidyDetailPage {
    ...
    constructor( public alertController: AlertController, public platform: Platform, public dbService: DatabaseServiceService, public router: Router, public navCtrl: NavController, public route: ActivatedRoute,
                public storage: Storage, public alertCtrl: AlertController, public httpClient: CommonService, public callNumber: CallNumber) {
    ...
    getOfflineData() {
        ...
        }else if (this.subsidyId == '8') {
            this.dbService.storage
                .executeSql('SELECT * FROM postVerificationOfflineOfSolar', [])
                .then((res) => {
                    var formPondList = [];
                    console.log('res', res);
                    if (res.rows.length > 0) {
        ...
        } else if (this.subsidyId == '24') {
            this.dbService.storage
                .executeSql('SELECT * FROM postVerificationOfflineOfPolyHouse', [])
                .then((res) => {
                    var formPondList = [];
                    console.log('res', res);
                    if (res.rows.length > 0) {
        ...
        } else if (this.subsidyId == '22') {
            this.dbService.storage
                .executeSql('SELECT * FROM postVerificationOfflineOfShadeNetHouse', [])
                .then((res) => {
                    var formPondList = [];
                    console.log('res', res);
                    if (res.rows.length > 0) {
                        ...
                        console.log('this.shadenethouseList', formPondList);
                        for (let j = 0; j < formPondList.length; j++) {
                            var tempObject = formPondList[j].applicationData;
                            this.postVerificationListData.push(JSON.parse(tempObject));
                            console.log('JSON.parse(tempObject)', JSON.parse(tempObject));
        ...
        } else if (this.subsidyId == '41') {
            this.dbService.storage
                .executeSql('SELECT * FROM postVerificationOfflineOfPlasticMulch', [])
                .then((res) => {
                    var formPondList = [];
                    console.log('res', res);
                    if (res.rows.length > 0) {
        ...
        } else if (this.subsidyId == '42') {
            this.dbService.storage
                .executeSql('SELECT * FROM postVerificationOfflineOfLowTunnel', [])
                .then((res) => {
                    var formPondList = [];
                    console.log('res', res);
                    if (res.rows.length > 0) {
                        ...
                        console.log('this.LowTunnelList', formPondList);
                        for (let j = 0; j < formPondList.length; j++) {
                            var tempObject = formPondList[j].applicationData;
                            this.postVerificationListData.push(JSON.parse(tempObject));
                            console.log('JSON.parse(tempObject)', JSON.parse(tempObject));
    ...
    goToDetails(data) {
       // alert(data);
        ...
        } else if (data.SubsidySchemeId == '8') {
            if (data.finalSubmission) {
                this.httpClient.showToast(
                    'This verification is already done. Please SYNC this verification'
                );
        ...
        } else if(data.SubsidySchemeId == '24'){
            this.router.navigate([
                'poly-house-post-verification',
                // "horticulture-application-details",
                {
                    data: JSON.stringify(data),
                    brandData: JSON.stringify(this.brandData),
        ...
        }  else if(data.SubsidySchemeId == '22'){
            this.router.navigate([
                'shade-net-house-post-verification',
                // "horticulture-application-details",
                {
                    data: JSON.stringify(data),
                    brandData: JSON.stringify(this.brandData),
        ...
        }  else if(data.SubsidySchemeId == '41'){
            this.router.navigate([
                'plastic-mulch-post-verification',
                // "horticulture-application-details",
                {
                    data: JSON.stringify(data),
                    brandData: JSON.stringify(this.brandData),
        ...
        } else if(data.SubsidySchemeId == '42') {
            this.router.navigate([
                'low-tunnel-post-verification',
                // "horticulture-application-details",
                {
                    data: JSON.stringify(data),
                    brandData: JSON.stringify(this.brandData),
        ...
        } else if(data.SubsidySchemeId == '61') {
            this.router.navigate([
                'onion-storage-post-verification',
                {
                    data: JSON.stringify(data),
                    brandData: JSON.stringify(this.brandData),
                },
            ]);
        } else if(data.SubsidySchemeId == '58') {
            this.router.navigate([
                'orchard-post-verification',
                {
                    data: JSON.stringify(data),
                    brandData: JSON.stringify(this.brandData),
                },
                ...
                if (res[0].status == 0) {
                    ...
                    for (let i = 0; i < self.postVerificationListData.length; i++) {
                        ...
                        if (
                            ...
                            self.subsidyId == '3' || self.subsidyId == '24' ||
                            self.subsidyId == '15' || self.subsidyId == '22' ||
                            self.subsidyId == '10' || self.subsidyId == '41' ||
                            self.subsidyId == '2' || self.subsidyId == '42'
                        ) {
                            self.brandData.push({
                            ...
                            for (let p = 0; p < this.postVerificationListData.length; p++) {
                                for (let t = 0; t < this.verifiedList.length; t++) {
                                    if (this.postVerificationListData[p].ApplicationId == this.verifiedList[t].ApplicationId) {
                                        ...
                                        this.verifiedList[t].isAlreadySaved = 2;
                                        this.postVerificationListData.unshift(this.verifiedList[t]);
                                        console.log('this.postVerificationOfflineOfPoly House RS', this.postVerificationListData);
                                    }
                            ...
                            for (let p = 0; p < this.postVerificationListData.length; p++) {
                                for (let t = 0; t < this.verifiedList.length; t++) {
                                    if (this.postVerificationListData[p].ApplicationId == this.verifiedList[t].ApplicationId) {
                                        ...
                                        this.verifiedList[t].isAlreadySaved = 2;
                                        this.postVerificationListData.unshift(this.verifiedList[t]);
                                        console.log('this.postVerificationOfflineOfShadeNetHouse RS', this.postVerificationListData);
                                    }
                            ...
                            for (let p = 0; p < this.postVerificationListData.length; p++) {
                                for (let t = 0; t < this.verifiedList.length; t++) {
                                    if (this.postVerificationListData[p].ApplicationId == this.verifiedList[t].ApplicationId) {
                                        ...
                                        this.verifiedList[t].isAlreadySaved = 2;
                                        this.postVerificationListData.unshift(this.verifiedList[t]);
                                        console.log('this.postVerificationOfflineOfPlasticMulch RS', this.postVerificationListData);
                                    }
                            ...
                            for (let p = 0; p < this.postVerificationListData.length; p++) {
                                for (let t = 0; t < this.verifiedList.length; t++) {
                                    if (this.postVerificationListData[p].ApplicationId == this.verifiedList[t].ApplicationId) {
                                        ...
                                        this.verifiedList[t].isAlreadySaved = 2;
                                        this.postVerificationListData.unshift(this.verifiedList[t]);
                                        console.log('this.postVerificationOfflineOfLowTunnel RS', this.postVerificationListData);
                                    }
        ...
        if (this.subsidyId == '1') {
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                      ...
                      //////Add jitendra  self.getHorticultureManufactureListDataMiniSprinkler(data);
                    } else {
                        self.showPrompt(res[0].data);
                    }
                },
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    self.postVerificationListData[index].isAlreadySaved = 1;
                     console.log('self.postVerificationListData = '+JSON.stringify(self.postVerificationListData));
                    if (res[0].status == 0) {
                        data.getVerificationCheckData = res[0].data;
                        for (var i = 0; i < data.getVerificationCheckData.length; i++) {
                            data.getVerificationCheckData[i].isSelectedClose = false;
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        ...
                        self.getPolyHouseManufactureListData(data,this.subsidyId);
                    } else {
                        self.showPrompt(res[0].data);
                    }
                },
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        ...
                        self.getShadNetHouseManufactureListData(data,this.subsidyId);
                    } else {
                        self.showPrompt(res[0].data);
                    }
                },
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        ...
                        self.getPlasticMulchManufactureListData(data,this.subsidyId);
                    } else {
                        self.showPrompt(res[0].data);
                    }
                },
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        ...
                        self.getLowTunnelManufactureListData(data,this.subsidyId);
                    } else {
                        self.showPrompt(res[0].data);
                    }
                },
    ...
    syncData(data) {
        if (this.subsidyId == 1) {
            ...
            if (data.imgOfConsentLetter) {
                this.uploadimgOfConsentLetterOfPolyHouse(data);
            } 
            // else if (data.basicDataSubmission.PrevAvailedSubsidyArray) {
            //     this.uploadimgOfPreAvailedSubsidy(data);
            // } 
                ...
                this.httpClient.showLoading();
                this.submitBasicDataOfPolyHouse(data);
            }
            ...
            if (data.imgOfConsentLetter) {
                this.uploadimgOfConsentLetterOfPlasticMulch(data);
            } 
            else {
                this.httpClient.showLoading();
                this.submitBasicDataOfPlasticMulch(data);
            }

        }
        else if (this.subsidyId == 42) {
            if (data.imgOfConsentLetter) {
                this.uploadimgOfConsentLetterOfLowTunnel(data);
            } 
            else {
                this.httpClient.showLoading();
                this.submitBasicDataOfLowTunnel(data);
            }
    ...
    uploadimgOfConsentLetterOfDrip(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
    ...
    uploadimgOfPreAvailedSubsidy(data) {
        ...
        for (let i = 0; i < tempArray.length; i++) {
            FileTransfer.create().upload(tempArray[i].ProofDoc, this.httpClient.imageUploadUrl, data.OptionsOfProofDoc).then((dataa) => {
                    var temp = JSON.parse(dataa.response);
                    console.log('temp[0].data', temp[0].data);
                    if (temp[0].data) {
    ...
    uploadimgOfPreAvailedSubsidyMiniSprinkler(data) {
        this.httpClient.showLoading();
        var tempArray = [];
        if(typeof data.prevAvailedSubsidyArray == "undefined"){
            tempArray = [];
            this.submitBasicDataOfMiniSprinkler(data);
        }else{
            tempArray = data.prevAvailedSubsidyArray;
    ...
    diggiPhoto1NoCase(data) {
        ...
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.photoFarmerWithOfficerNoCase, this.httpClient.imageUploadUrl, data.optionsOfPhotoFarmerWithOfficerNoCase).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
                if (temp[0].data) {
                    data.finalSubmission.ImgFarmerWithOfficer = temp[0].data;
    ...
    diggiPhoto2NoCase(data) {
        ...
        FileTransfer.create().upload(data.photoFarmerApprovalCertificate, this.httpClient.imageUploadUrl, data.optionsOfphotoFarmerApprovalCertificate).then((dataa) => {
    ...
    /*POLY HOUSE*/
    getPolyHouseManufactureListData(data,subsidyId) {
        console.log(data);
        var self = this;
        var sendRequestData = {
            obj: {
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    data.getHorticultureManufactureData = res[0].data;
                    self.getLandAreaListData(data,subsidyId);
    ...
    getLandAreaListData(data,subsidyId){
          var self = this;
          self.httpClient.showLoadingImage();
          var sendRequestData = {
              obj: {
          ...
          this.httpClient.post(sendRequestData).subscribe(
              function(res: any) {
                  ...
                  if (res[0].status == 0) {
                    data.landAreaList = res[0].data;
                    self.dbService.addpostVerificationOfflineOfPolyHouse(data.ApplicationId, JSON.stringify(data));
                    // self.submitBasicDataOfPolyHouse(data);
                    // data.getHorticultureManufactureData = res[0].data;
                    // self.getLandAreaListData(data,subsidyId);
                  } else {
                      self.showPrompt(res[0].data);
    ...
    submitBasicDataOfPolyHouse(data) {
        var self = this;
        var sendRequestData = {
            obj: {
                usrnm: 'rajkisan',
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                console.log(' AddSprinklerPostVerification res', res);
                if (res[0].status == 0) {
                    self.uploadBillsApiOfPolyHouse(data, res[0].data[0].PostVerificationId, 0);
                } else {
                    self.httpClient.showToast(res[0].message);
                }
            },
    ...
    uploadimgOfConsentLetterOfPolyHouse(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
    ...
    uploadBillsApiOfPolyHouse(data, postverificationId, param) {
        console.log('postverificationId', postverificationId);
        console.log('uploadBillsApi(data', data);
        var self = this;
        var sendRequestData = {
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    if (param == data.billDetails.length - 1) {
                        self.uploadFirstPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        self.uploadBillsApiOfPolyHouse(data, postverificationId, param + 1);
                    }
    ...
    finalSubmissionOfPolyHouse(data) {
        var self = this;
        var sendRequestData = data.finalSubmission;
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                ...
                if (res[0].status == 0) {
                    console.log(res);
                    self.dbService.storage.executeSql('DELETE FROM postVerificationOfflineOfPolyHouse WHERE ApplicationId = ?', [data.ApplicationId]).then((_) => {
                        self.successAlertFinalSubmission();
    ...
    uploadNinthPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgPVChecklistDocument;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgPVChecklistDocument, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.finalSubmissionOfPolyHouse(data);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadEighthPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerSatisfactionConsentLetter;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgFarmerSatisfactionConsentLetter, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadNinthPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSeventhPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgInsuranceCertificateCopy;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgInsuranceCertificateCopy, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadEighthPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSixthPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgSubsidyComponentFarmerWithOfficer2, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSeventhPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFifthPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgSubsidyComponentFarmerWithOfficer1, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSixthPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFourthPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgSubsidyInstalledPlaceFarmerWithOfficer2, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFifthPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadThirdPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            .upload(data.ImgSubsidyInstalledPlaceFarmerWithOfficer1, this.httpClient.imageUploadUrl, tempOption)
            .then(
                (dataa) => {
                    // success
                    var temp = JSON.parse(dataa.response);
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFourthPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSecondPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadThirdPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFirstPhotoOfPolyHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSecondPhotoOfPolyHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadBillDetailsofPloyHouse(data, postverificationId, param) {
        console.log(' ApplicationId bill', postverificationId);
        console.log(' data.billDetails[param].BillImg', data.billDetails[param].BillImg);
        var self = this;
        FileTransfer.create()
            ...
            .then(
                (dataTwo) => {
                    ...
                    if (param == data.billDetails.length - 1) {
                        console.log('in chaek');
                        self.uploadBillsApiOfPolyHouse(data, postverificationId, 0);
                    } else {
                        self.uploadBillDetailsofPloyHouse(data, postverificationId, param + 1);
                    }
                },
                (err) => {
                    // error
    ...
    uploadingOfConsentLetterOfPolyHouse(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
    ...
    uploadingOfPreAvailedSubsidy(data) {
        this.httpClient.showLoading();
        var tempArray = [];
        tempArray = data.prevAvailedSubsidyArray;
        for (let i = 0; i < tempArray.length; i++) {
    ...
    /*SHADE NET HOUSE*/
    getShadNetHouseManufactureListData(data,subsidyId) {
        var self = this;
        var sendRequestData = {
            obj: {
                usrnm: 'rajkisan',
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    data.getHorticultureManufactureData = res[0].data;
                    self.getShadeNetLandAreaListData(data,subsidyId);
    ...
    getShadeNetLandAreaListData(data,subsidyId){
          var self = this;
          self.httpClient.showLoadingImage();
          var sendRequestData = {
              obj: {
          ...
          this.httpClient.post(sendRequestData).subscribe(
              function(res: any) {
                  ...
                  if (res[0].status == 0) {
                    data.landAreaList = res[0].data;
                    self.dbService.addpostVerificationOfflineOfShadeNetHouse(data.ApplicationId, JSON.stringify(data));
                    // self.submitBasicDataOfShadeNetHouse(data);
                    // data.getHorticultureManufactureData = res[0].data;
                    // self.getLandAreaListData(data,subsidyId);
                  } else {
                      self.showPrompt(res[0].data);
    ...
    uploadimgOfConsentLetterOfShadeNetHouse(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
                if (temp[0].data) {
                    data.basicDataSubmission.ImgConsentLetter = temp[0].data;
                    this.submitBasicDataOfShadeNetHouse(data);
                } else {
                    this.httpClient.showToastError();
                }
            },
    ...
    submitBasicDataOfShadeNetHouse(data) {
        console.log('====================================');
        console.log(data);
        console.log('====================================');
        var self = this;
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                console.log(' AddSprinklerPostVerification res', res);
                if (res[0].status == 0) {
                    self.uploadBillsApiOfShadeNetHouse(data, res[0].data[0].PostVerificationId, 0);
                } else {
                    self.httpClient.showToast(res[0].message);
                }
            },
    ...
    uploadBillsApiOfShadeNetHouse(data, postverificationId, param) {
        console.log('postverificationId', postverificationId);
        console.log('uploadBillsApi(data', data);
        var self = this;
        var sendRequestData = {
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    if (param == data.billDetails.length - 1) {
                        self.uploadFirstPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        self.uploadBillsApiOfShadeNetHouse(data, postverificationId, param + 1);
                    }
    ...
    finalSubmissionOfShadeNetHouse(data) {
        var self = this;
        var sendRequestData = data.finalSubmission;
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                ...
                if (res[0].status == 0) {
                    console.log(res);
                    self.dbService.storage.executeSql('DELETE FROM postVerificationOfflineOfShadeNetHouse WHERE ApplicationId = ?', [data.ApplicationId]).then((_) => {
                        self.successAlertFinalSubmission();
    ...
    uploadNinthPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgPVChecklistDocument;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.finalSubmissionOfShadeNetHouse(data);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadEighthPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerSatisfactionConsentLetter;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadNinthPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSeventhPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgInsuranceCertificateCopy;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadEighthPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSixthPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSeventhPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFifthPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSixthPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFourthPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFifthPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadThirdPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFourthPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSecondPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadThirdPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFirstPhotoOfShadeNetHouse(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSecondPhotoOfShadeNetHouse(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadBillDetailsofShadeNetHouse(data, postverificationId, param) {
        console.log(' ApplicationId bill', postverificationId);
        console.log(' data.billDetails[param].BillImg', data.billDetails[param].BillImg);
        var self = this;
        FileTransfer.create()
            ...
            .then(
                (dataTwo) => {
                    ...
                    if (param == data.billDetails.length - 1) {
                        console.log('in chaek');
                        self.uploadBillsApiOfShadeNetHouse(data, postverificationId, 0);
                    } else {
                        self.uploadBillDetailsofShadeNetHouse(data, postverificationId, param + 1);
                    }
                },
                (err) => {
                    // error
    ...
    uploadingOfConsentLetterOfShadeNetHouse(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
    ...
    /*SHADE NET HOUSE END*/
     ...
     /*PLASTIC MULCH*/
     getPlasticMulchManufactureListData(data,subsidyId) {
        var self = this;
        var sendRequestData = {
            obj: {
                usrnm: 'rajkisan',
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    data.getHorticultureManufactureData = res[0].data;
                    self.getPlasticMulchLandAreaListData(data,subsidyId);
    ...
    getPlasticMulchLandAreaListData(data,subsidyId){
          var self = this;
          self.httpClient.showLoadingImage();
          var sendRequestData = {
              obj: {
          ...
          this.httpClient.post(sendRequestData).subscribe(
              function(res: any) {
                  ...
                  if (res[0].status == 0) {
                    data.landAreaList = res[0].data;
                    self.dbService.addpostVerificationOfflineOfPlasticMulch(data.ApplicationId, JSON.stringify(data));
                    // self.submitBasicDataOfPlasticMulch(data);
                    // data.getHorticultureManufactureData = res[0].data;
                    // self.getLandAreaListData(data,subsidyId);
                  } else {
                      self.showPrompt(res[0].data);
    ...
    uploadimgOfConsentLetterOfPlasticMulch(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
    ...
    submitBasicDataOfPlasticMulch(data) {
        var self = this;
        var sendRequestData = {
            obj: {
                usrnm: 'rajkisan',
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                console.log(' AddSprinklerPostVerification res', res);
                if (res[0].status == 0) {
                    self.uploadBillsApiOfPlasticMulch(data, res[0].data[0].PostVerificationId, 0);
                } else {
                    self.httpClient.showToast(res[0].message);
                }
            },
    ...
    uploadBillsApiOfPlasticMulch(data, postverificationId, param) {
        console.log('postverificationId', postverificationId);
        console.log('uploadBillsApi(data', data);
        var self = this;
        var sendRequestData = {
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    if (param == data.billDetails.length - 1) {
                        self.uploadFirstPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        self.uploadBillsApiOfPlasticMulch(data, postverificationId, param + 1);
                    }
    ...
    finalSubmissionOfPlasticMulch(data) {
        var self = this;
        var sendRequestData = data.finalSubmission;
    ...
    uploadNinthPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgPVChecklistDocument;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.finalSubmissionOfPlasticMulch(data);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadEighthPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerSatisfactionConsentLetter;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadNinthPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSeventhPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgInsuranceCertificateCopy;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadEighthPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSixthPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSeventhPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFifthPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSixthPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFourthPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFifthPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadThirdPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFourthPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSecondPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadThirdPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFirstPhotoOfPlasticMulch(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSecondPhotoOfPlasticMulch(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadBillDetailsofPlasticMulch(data, postverificationId, param) {
        console.log(' ApplicationId bill', postverificationId);
        console.log(' data.billDetails[param].BillImg', data.billDetails[param].BillImg);
        var self = this;
        FileTransfer.create()
            ...
            .then(
                (dataTwo) => {
                    ...
                    if (param == data.billDetails.length - 1) {
                        console.log('in chaek');
                        self.uploadBillsApiOfPlasticMulch(data, postverificationId, 0);
                    } else {
                        self.uploadBillDetailsofPlasticMulch(data, postverificationId, param + 1);
                    }
                },
                (err) => {
                    // error
    ...
    uploadingOfConsentLetterOfPlasticMulch(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
    ...
    /*PLASTIC MULCH END*/
     ...
     /*LOW TUNNEL*/
     getLowTunnelManufactureListData(data,subsidyId) {
        var self = this;
        var sendRequestData = {
            obj: {
                usrnm: 'rajkisan',
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    data.getHorticultureManufactureData = res[0].data;
                    self.getLowTunnelLandAreaListData(data,subsidyId);
    ...
    getLowTunnelLandAreaListData(data,subsidyId){
          var self = this;
          self.httpClient.showLoadingImage();
          var sendRequestData = {
              obj: {
    ...
    uploadimgOfConsentLetterOfLowTunnel(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
    ...
    submitBasicDataOfLowTunnel(data) {
        var self = this;
        var sendRequestData = {
            obj: {
                usrnm: 'rajkisan',
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                console.log(' AddSprinklerPostVerification res', res);
                if (res[0].status == 0) {
                    self.uploadBillsApiOfLowTunnel(data, res[0].data[0].PostVerificationId, 0);
                } else {
                    self.httpClient.showToast(res[0].message);
                }
            },
    ...
    uploadBillsApiOfLowTunnel(data, postverificationId, param) {
        console.log('postverificationId', postverificationId);
        console.log('uploadBillsApi(data', data);
        var self = this;
        var sendRequestData = {
        ...
        this.httpClient.post(sendRequestData).subscribe(
            function(res: any) {
                if (res[0].status == 0) {
                    if (param == data.billDetails.length - 1) {
                        self.uploadFirstPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        self.uploadBillsApiOfLowTunnel(data, postverificationId, param + 1);
                    }
    ...
    finalSubmissionOfLowTunnel(data) {
        var self = this;
        var sendRequestData = data.finalSubmission;
    ...
    uploadNinthPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgPVChecklistDocument;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.finalSubmissionOfLowTunnel(data);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadEighthPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerSatisfactionConsentLetter;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadNinthPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSeventhPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgInsuranceCertificateCopy;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    if (temp[0].data[0].URL) {
                        // this.finalSubmissionOfPolyHouse(data);
                        this.uploadEighthPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSixthPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSeventhPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFifthPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyComponentFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSixthPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFourthPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFifthPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadThirdPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgSubsidyInstalledPlaceFarmerWithOfficer1;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadFourthPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadSecondPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer2;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadThirdPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadFirstPhotoOfLowTunnel(data, postverificationId) {
        console.log('data', data);
        console.log('postverificationId', postverificationId);
        var tempOption = data.optionOfImgFarmerWithOfficer;
        tempOption.params.id = postverificationId;
        FileTransfer.create()
            ...
            .then(
                (dataa) => {
                    ...
                    console.log('diggi1', temp[0].data);
                    if (temp[0].data[0].URL) {
                        this.uploadSecondPhotoOfLowTunnel(data, postverificationId);
                    } else {
                        this.httpClient.showToastError();
                    }
                },
    ...
    uploadBillDetailsofLowTunnel(data, postverificationId, param) {
        console.log(' ApplicationId bill', postverificationId);
        console.log(' data.billDetails[param].BillImg', data.billDetails[param].BillImg);
        var self = this;
        FileTransfer.create()
            ...
            .then(
                (dataTwo) => {
                    ...
                    if (param == data.billDetails.length - 1) {
                        console.log('in chaek');
                        self.uploadBillsApiOfLowTunnel(data, postverificationId, 0);
                    } else {
                        self.uploadBillDetailsofLowTunnel(data, postverificationId, param + 1);
                    }
                },
                (err) => {
                    // error
    ...
    uploadingOfConsentLetterOfLowTunnel(data) {
        this.httpClient.showLoading();
        FileTransfer.create().upload(data.imgOfConsentLetter, this.httpClient.imageUploadUrl, data.optionsOfimgOfConsentLetter).then((dataa) => {
                var temp = JSON.parse(dataa.response);
                console.log('temp[0].data', temp[0].data);
