...
export class SubsidyDashboardPage {
  ...
  constructor(public platform: Platform, public dbService: DatabaseServiceService, public navCtrl: NavController, public storage: Storage, public router: Router, public route: ActivatedRoute,
