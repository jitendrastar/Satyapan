...
export class MicroSprinklerPostVerificationPage {
    ...
    microSprinklerList: any[] = [];
    microSprinklerValue: any;
    ...
    constructor(
        ...
        public storage: Storage, public ngZone: NgZone,
        ...
        if (!this.httpClient.isOffline) {
            ...
            if (parseInt(this.data.PostVerificationId) > 0) {
                ...
                if(JSON.stringify(this.data.SpaceTypeId) != ''){
                    this.microSprinklerValue = JSON.stringify(this.data.SpaceTypeId);
                }
                this.getBills();
            }
        ...
        this.getISILIST();
        this.getMicroSprinklerList();
    }

    getMicroSprinklerList() {
        if (this.httpClient.isOffline) {
            this.microSprinklerValue = JSON.stringify(this.data.SpaceTypeId);
        } else {
            var self = this;
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        self.microSprinklerList = res[0].data;
                    } else {
    ...
    getAddSprinklerPostVerification() {
        ...
        if (this.longitude == null ||this.longitude == null ||this.longitude  == null) {
            ...
            this.btnAddSprinkler = false;
        } else if (this.microSprinklerValue == null || this.microSprinklerValue == '') {
            if (this.httpClient.currentLanguage == 'hindi') {
                ...
                this.dbService.storage.executeSql("SELECT * FROM postVerificationOfflineOfMicroSprinkler WHERE ApplicationId = ?",
                    [this.data.ApplicationId]).then((res) => {
                        ...
                        temp.basicDataSubmission = {
                            ...
                            PVSpaceTypeId: this.microSprinklerValue,
                        ...
                        var errorRequestData = {
                            'obj': {
                                ...
                                srvparam: JSON.stringify({
                                    ...
                                    PVSpaceTypeId: self.microSprinklerValue,
