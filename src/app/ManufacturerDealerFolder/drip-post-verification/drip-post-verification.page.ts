...
export class DripPostVerificationPage {
    ...
    constructor(
        ...
        public file: File, public ngZone: NgZone,
        ...
        this.data = JSON.parse(this.route.snapshot.paramMap.get('data'));
         //   alert(JSON.stringify(this.data.SpaceTypeId));
        this.spacingTypeValue = JSON.stringify(this.data.SpaceTypeId);
    ...
    console.log('arr ', this.arr);
        ...
        if (!this.httpClient.isOffline) {
            ...
            if (parseInt(this.data.PostVerificationId) > 0) {
                ...
                if(JSON.stringify(this.data.SpaceTypeId) != ''){
                    this.spacingTypeValue = JSON.stringify(this.data.SpaceTypeId);
                }
                this.getBills();
            }
        ...
        this.getSpacingTypeDetailList();
    }

    getSpacingTypeDetailList() {
        if (this.httpClient.isOffline) {
            this.spacingTypeValue = JSON.stringify(this.data.SpaceTypeId);
        } else {
            var self = this;
            ...
            var sendRequestData = {
                obj: {
                    ...
                    srvnm: 'HortiSubsidy',
                    srvmethodnm: 'GetSpacingTypeBySubsidyId',
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        self.spacingTypeDetailList = res[0].data;
           ...
           /* setTimeout(() => {
                if(this.data.SpaceTypeId){
                    this.spacingTypeValue = this.data.SpaceTypeId;
                }
                console.log("***************************", this.data.SpaceTypeId);
                console.log("***************************", this.spacingTypeValue);
            }, 1000);*/
        }
    }
    ...
    getAddSprinklerPostVerification() {
        ...
        console.log(checkArray);
         ...
         if (this.longitude == null ||this.longitude == null ||this.longitude  == null) {
            ...
            this.btnAddSprinkler = false;
        } else if (this.spacingTypeValue == null || this.spacingTypeValue == '') {
            if (this.httpClient.currentLanguage == 'hindi') {
                this.httpClient.showToast('कृपया अंतराल (स्पेसिंग) के प्रकार का चयन करें');
            } else {
                this.httpClient.showToast('Please select the Spacing Type');
            }
            this.btnAddSprinkler = false;
                ...
                this.dbService.storage.executeSql('SELECT * FROM postVerificationOfflineOfDrip WHERE ApplicationId = ?',
                    ...
                    temp.basicDataSubmission = {
                       ...
                       // longitude: this.httpClient.longitude,
                        ...
                        PVSpaceTypeId: this.spacingTypeValue,
                        ...
                        var errorRequestData = {
                            'obj': {
                                ...
                                srvparam: JSON.stringify({
                                    ...
                                    PVSpaceTypeId: self.spacingTypeValue,
