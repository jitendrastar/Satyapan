...
export class MiniSprinklerPostVerificationPage {
    ...
    listOfISIMarks: any;
    miniSprinklerList: any[] = [];
    miniSprinklerValue: any;
    ...
    constructor(
        ...
        public camera: Camera,public ngZone: NgZone,
        ...
        if (!this.httpClient.isOffline) {
            ...
            if (parseInt(this.data.PostVerificationId) > 0) {
                ...
                if(JSON.stringify(this.data.SpaceTypeId) != ''){
                    this.miniSprinklerValue = JSON.stringify(this.data.SpaceTypeId);
                }
                this.getBills();
            }
        ...
        if (this.httpClient.isOffline) {
            ...
            this.httpClient.post(sendRequestData).subscribe(
                function(res: any) {
                    ...
                    if (res[0].status == 0) {
                        self.miniSprinklerList = res[0].data;
                    } else {
    ...
    getAddSprinklerPostVerification() {
        ...
        } else if (this.miniSprinklerValue == null || this.miniSprinklerValue == '') {
            if (this.httpClient.currentLanguage == 'hindi') {
                    ...
                    [this.data.ApplicationId]).then((res) => {
                        ...
                        temp.basicDataSubmission = {
                          ...
                          //  longitude: this.httpClient.longitude,
                            ...
                            PVSpaceTypeId: this.miniSprinklerValue,
                        ...
                        var errorRequestData = {
                            'obj': {
                                ...
                                srvparam: JSON.stringify({
                                    ...
                                    PVSpaceTypeId: self.miniSprinklerValue,
