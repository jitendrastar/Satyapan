...
export class HorticultureApplicationDetailsPage {
    ...
    btnsubmitFinalData:boolean = false;
  ...
  */
    ...
    */
    ...
    getAddSprinklerPostVerification() {
       ...
       else if (this.hortiHectareModelRange == null || this.hortiHectareModelRange == '') {
            if (this.httpClient.currentLanguage == 'hindi') {
    ...
    select_loc_withIMG_farmer(flags,columnNames){
        ...
        //if (this.lat == null || this.lat == ""|| this.lat == undefined) {
         if (this.longitude == null ||this.longitude == null ||this.longitude  == null) {
                      ...
                      this.selectImage(flags, columnNames);
                  }
    }
